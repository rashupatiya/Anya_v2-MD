...
global.botname = process.env.BotName || "Rashu Music" 
global.author = process.env.Author || "@RashuMusic" 
global.packname = process.env.PackName || "RASHU MUSIC💗🥺" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© Rashu Music Bot" 
global.prefa = process.env.Prefix || ['.'] 
global.themeemoji = process.env.ThemeEmoji || "🎐" 
global.ownername = process.env.Owner_Name || "RASHU-MUSIC💗" 
global.ownernumber = process.env.Owner_Number || "94729569031" 
global.adress = process.env.Continent || "Asia, srilanka, kolombo" 
global.timezone = process.env.TimeZone || "Asia/Kolkata" 
global.instagramId = process.env.Insta || "8.08_only_mine" 
global.email = process.env.Email_Id || "example@example.com" 

global.mongoUrl = process.env.MongoDB || "mongodb+srv://Darkaroow:modzdark1234@cluster0.orfhyfe.mongodb.net/"; 
...
module.exports = {
  botname: process.env.BotName || "Rashu Music", 
  author: process.env.Author || "@RashuMusic",
  packname: process.env.PackName || "Queen Anya v2 MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Rashu Music Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Pika~Kun",
  ownernumber: process.env.Owner_Number || "94729569031",
  adress: process.env.Continent || "Asia, India, Assam",
  timezone: process.env.TimeZone || "Asia/Kolkata", 
  instagramId: process.env.Insta || "8.08_only_mine",
  email: process.env.Email_Id || "example@example.com",
  warns: process.env.Warns_Limits || 3,
  mongoUrl: process.env.MongoDB || "mongodb+srv://Darkaroow:modzdark1234@cluster0.orfhyfe.mongodb.net/",
  welcome: process.env.Welcome_Msg || '*@$user* joined this group today as $membersth member.\n\n_$prefix welcome off to disable this message._',
  left: process.env.Left_Msg || 'Ex-member *@$user* is no longer available in this group chat.\n\n_$prefix goodbye off to disable this message._',
  promote: process.env.Promote_Msg || '*@$user* has been promoted as an admin in this group.\n\n_$prefix promotem off to disable this message._',
  demote: process.env.Demote_Msg || '*@$user* has been demoted to a member in this group.\n\n_$prefix demotem off to disable this message._',
  sessionId: process.env.SESSION_ID || "RERjMUh_Queen-Anya_1Y1Y=", 
